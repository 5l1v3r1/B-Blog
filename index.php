<?php
  ...
  if( !isset($_POST['A']) )
	...
	$POSTS = $SQL->query('SELECT P.ID,P.TITLE,P.STEXT,P.TIME,U.NAME AS AUTHOR,C.ID AS CID,C.NAME AS CNAME FROM POSTS AS P, USERS AS U, CATS AS C WHERE P.TYPE=1 AND P.AUTHOR=U.ID AND P.CAT=C.ID;');
