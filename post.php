<?php
	...
	if( isset($_GET['id']) && (int)$_GET['id']>0 )
	{
		...
		$GET_POST = $SQL->query("SELECT P.ID,P.TITLE,P.STEXT,P.FTEXT,P.TIME,P.TAGS,U.USER,U.NAME,C.ID,C.NAME FROM POSTS AS P, USERS AS U, CATS AS C WHERE P.POSTER=U.ID AND P.CAT=C.ID AND P.ID=".$POSTID.";");
